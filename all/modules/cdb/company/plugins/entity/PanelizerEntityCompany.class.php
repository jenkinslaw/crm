 ...
 *
 * Handles company specific functionality for Panelizer.
 */
class PanelizerEntityCompany extends PanelizerEntityDefault {
  /**
  ...
  public function entity_identifier($entity) {
    return t('This company');
  }

  public function entity_bundle_label() {
    return t('Company type');
  }
